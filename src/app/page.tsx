...
export default function Home() {
  ...
  return (
    <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,440px),1fr))', gap: 'clamp(3rem,6vw,5rem)', alignItems: 'center' }}>
            ...
            <div className="rv">
              <div style={{ position: 'relative', height: '480px', overflow: 'hidden' }}>
                <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&q=80" alt="Red Stag handyman professional repairing drywall in Los Angeles home" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
      ...
      {/* PHOTO GRID */}
      <div className="pg">
        <div className="pk"><img src="https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80" alt="Professional drywall repair in Los Angeles" loading="lazy" /><div className="pko"><div style={{ fontFamily: 'var(--font-barlow)', fontWeight: 700, fontSize: '.9rem', color: '#fff', textTransform: 'uppercase', letterSpacing: '.06em' }}>Drywall Repair</div><div style={{ fontFamily: 'var(--font-crimson)', fontSize: '.8rem', color: 'rgba(255,255,255,.5)' }}>Same-day texture matching</div></div></div>
        <div className="pk"><img src="https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=600&q=80" alt="Door installation handyman service" loading="lazy" /><div className="pko"><div style={{ fontFamily: 'var(--font-barlow)', fontWeight: 700, fontSize: '.9rem', color: '#fff', textTransform: 'uppercase', letterSpacing: '.06em' }}>Door Installation</div><div style={{ fontFamily: 'var(--font-crimson)', fontSize: '.8rem', color: 'rgba(255,255,255,.5)' }}>Interior & exterior</div></div></div>
        <div className="pk"><img src="https://images.unsplash.com/photo-1504148455328-c376907d081c?w=600&q=80" alt="Professional fixture installation" loading="lazy" /><div className="pko"><div style={{ fontFamily: 'var(--font-barlow)', fontWeight: 700, fontSize: '.9rem', color: '#fff', textTransform: 'uppercase', letterSpacing: '.06em' }}>Fixture Installs</div><div style={{ fontFamily: 'var(--font-crimson)', fontSize: '.8rem', color: 'rgba(255,255,255,.5)' }}>Lights, fans, smart home</div></div></div>
        <div className="pk"><img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=600&q=80" alt="Handyman tools and equipment" loading="lazy" /><div className="pko"><div style={{ fontFamily: 'var(--font-barlow)', fontWeight: 700, fontSize: '.9rem', color: '#fff', textTransform: 'uppercase', letterSpacing: '.06em' }}>Full-Service</div><div style={{ fontFamily: 'var(--font-crimson)', fontSize: '.8rem', color: 'rgba(255,255,255,.5)' }}>One call handles it all</div></div></div>
      </div>
